...
dummyDf$category <- gsub('Mayo\\_comprehensive',
                         'Mayo Oligo Modules',
                         dummyDf$category)

dummyDf$category <- gsub('Columbia\\_Broad\\_Rush\\_m109',
                         'ROSMAP m109',
                         dummyDf$category)
...
dummyDf$category <- gsub('igap',
                         'IGAP',
                         dummyDf$category)

dummyDf$category <- gsub('biocarta',
                         'Biocarta',
                         dummyDf$category)

dummyDf$category <- gsub('genecards',
                         'Genecards',
                         dummyDf$category)

dummyDf$category <- gsub('kegg',
                         'KEGG',
                         dummyDf$category)

dummyDf$category <- gsub('wikipathwaysHuman',
                         'Wikipathways Human',
                         dummyDf$category)

dummyDf$category <- gsub('pantherPresenilin',
                         'Panther Presenilin',
                         dummyDf$category)

dummyDf$category <- gsub('dbgap',
                         'dbGaP',
                         dummyDf$category)

dummyDf$category <- gsub('omimExpanded',
                         'OMIM Expanded',
                         dummyDf$category)
